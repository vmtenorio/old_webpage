...
var backgroundColors = ["#d67e8b", "#d06b79", "#c95868", "#c24558", "#b23b4d", "#9f3645", "#8b303d", "#782a35", "#65232d", "#511d25"];
var ctx = document.getElementById("skill-chart");
var chartConfig = {
  type: 'bar',
  data: {
    labels: ["Python", "Programming", "Unix", "Machine Learning", "PyTorch", "TensorFlow", "Keras", "Pandas and Data Analytics", "IAM Tools", "PAM Tools"],
    datasets: [
      {
